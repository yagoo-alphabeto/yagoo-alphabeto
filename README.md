...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=0077B5&size=35&center=true&vCenter=true&width=1000&lines=Hello,+my+name+is+Yagoo+Pereira;Technology+Enthusiast+and+Data+Engineer;Be+welcome!)](https://git.io/typing-svg)


<!-- Seção de Bio -->
## 👨‍💻 Sobre Mim
Olá, eu sou Yagoo Pereira! 👋
Sou engenheiro e entusiasta em tecnologia, com experiência em gestão de empresas e no desenvolvimento de soluções inovadoras. Aqui, você encontrará projetos que refletem minha paixão por dados, gestão e tecnologia.

Seja bem-vindo ao meu GitHub! Explore meus repositórios, compartilhe suas ideias.

Vamos colaborar para construir um futuro mais tecnológico e eficiente! 💡
...
- Linguagens de Programação (JavaScript, Python, C, C#, R)
- Banco de Dados (SQL Server, PostgresSQL, MongoDB, Neo4j, Cassandra)
<!-- - Plataformas e ERPs: (VTEX, Loja Integrada, Totvs, CISSPoder, Linx Microvix) -->
